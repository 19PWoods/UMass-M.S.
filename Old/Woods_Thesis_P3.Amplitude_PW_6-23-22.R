  ...
  titlePanel("Stretch Activation and Fatigue - Woods' Masters Thesis"),
    sidebarPanel(
      ...
      conditionalPanel(
        ...
        actionButton("set_phase_3", "Set Phase 3"),
        downloadButton("download_amp", "Download Amplitude")),

      conditionalPanel(
        condition = "input.tabselected==2",
        actionButton("set_rate_phases", "Set Phases 2-4"),
        downloadButton("download_rate", "Download Rates"))
      ),
