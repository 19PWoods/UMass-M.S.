...
ggI <- ggplot(data = i_df, aes(x = Po_Pre_Step, y = Fsa)) +
  ...
  annotate("text", x = 300, y = 15, label = signif(i_lm$coefficients[1], 3)) +
  annotate("text", x = 300, y = 14, label = signif(i_lm$coefficients[2], 3))
...
ggIIA <-ggplot(data = IIA_df, aes(x = Po_Pre_Step, y = Fsa)) +
  ...
  annotate("text", x = 110, y = 60, label = signif(IIA_5.1_lm$coefficients[1], 3)) +
  annotate("text", x = 110, y = 56, label = signif(IIA_5.1_lm$coefficients[2], 3)) +
  annotate("text", x = 240, y = 55, label = signif(IIA_4.5_lm$coefficients[1], 3)) +
  annotate("text", x = 240, y = 51, label = signif(IIA_4.5_lm$coefficients[2], 3)) +
  annotate("text", x = 340, y = 35, label = signif(IIA_act_lm$coefficients[1], 3)) +
  annotate("text", x = 340, y = 31, label = signif(IIA_act_lm$coefficients[2], 3))
...
ggIIX <-ggplot(data = IIX_df, aes(x = Po_Pre_Step, y = Fsa)) +
  ...
  geom_line(data = IIXact,
            ...
            linetype = "solid",
            aes(x = Po_Pre_Step,y = act)) +
  annotate("text", x = 80, y = 60, label = signif(IIX_5.1_lm$coefficients[1], 3)) +
  annotate("text", x = 80, y = 56, label = signif(IIX_5.1_lm$coefficients[2], 3)) +
  annotate("text", x = 215, y = 60, label = signif(IIX_4.5_lm$coefficients[1], 3)) +
  annotate("text", x = 215, y = 56, label = signif(IIX_4.5_lm$coefficients[2], 3)) +
  annotate("text", x = 250, y = 30, label = signif(IIX_act_lm$coefficients[1], 3)) +
  annotate("text", x = 250, y = 26, label = signif(IIX_act_lm$coefficients[2], 3))
...
ggIIB <-ggplot(data = IIB_df, aes(x = Po_Pre_Step, y = Fsa)) +
  ...
  geom_line(data = IIBact,
            ...
            linetype = "solid",
            aes(x = Po_Pre_Step,y = act)) +
    annotate("text", x = 55, y = 40, label = signif(IIB_5.1_lm$coefficients[1], 3)) +
  annotate("text", x = 55, y = 36, label = signif(IIB_5.1_lm$coefficients[2], 3)) +
  annotate("text", x = 200, y = 60, label = signif(IIB_4.5_lm$coefficients[1], 3)) +
  annotate("text", x = 200, y = 56, label = signif(IIB_4.5_lm$coefficients[2], 3)) +
  annotate("text", x = 240, y = 35, label = signif(IIB_act_lm$coefficients[1], 3)) +
  annotate("text", x = 240, y = 31, label = signif(IIB_act_lm$coefficients[2], 3))


# df4 <- read_excel("SA-Fatigue_Tension+Step+Kinetics_PW_10-28-22.xlsx", 
#                       sheet = "Included",
#                       skip = 5,
#                       na="") %>% 
#   filter(Exp_Con_Num %in% c(3,5,6)) %>% 
