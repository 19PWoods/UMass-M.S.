...
ggI <- ggplot(data = i_df, aes(x = Po_Pre_Step, y = Fsa)) +
  ...
  # annotate("text", x = 300, y = 15, label = i_lm$coefficients[1]) +
  # annotate("text", x = 300, y = 14, label = i_lm$coefficients[2])
...
ggIIA <-ggplot(data = IIA_df, aes(x = Po_Pre_Step, y = Fsa)) +
  ...
  geom_line(data = IIA5.1,
            ...
            aes(x = Po_Pre_Step,
                y = lowfat,
                text = paste(c("Intercept",IIA_5.1_lm$coefficients[1],
                               "Slope", IIA_5.1_lm$coefficients[2])))) +
  geom_line(data = IIA4.5,
            size = 1,
            linetype = "longdash",
            aes(x = Po_Pre_Step,y = highfat,
                text = paste("Slope", IIA_4.5_lm$coefficients[2]))) +
  geom_line(data = IIAact,
            size = 1,
            linetype = "solid",
            aes(x = Po_Pre_Step,y = act,
                text = paste("Slope", IIA_act_lm$coefficients[2]))
            )
...
ggIIX <-ggplot(data = IIX_df, aes(x = Po_Pre_Step, y = Fsa)) +
  ...
  geom_line(data = IIX5.1,
            ...
            aes(x = Po_Pre_Step,
                y = lowfat,
                text = paste("Slope", IIX_5.1_lm$coefficients[2]))) +
  geom_line(data = IIX4.5,
            size = 1,
            linetype = "longdash",
            aes(x = Po_Pre_Step,y = highfat,
                text = paste("Slope", IIX_4.5_lm$coefficients[2]))) +
  geom_line(data = IIXact,
            size = 1,
            linetype = "solid",
            aes(x = Po_Pre_Step,y = act,
                text = paste("Slope", IIX_act_lm$coefficients[2])))
...
ggIIB <-ggplot(data = IIB_df, aes(x = Po_Pre_Step, y = Fsa)) +
  ...
  geom_line(data = IIB5.1,
            ...
            aes(x = Po_Pre_Step,
                y = lowfat,
                text = paste("Slope", IIB_5.1_lm$coefficients[2]))) +
  geom_line(data = IIB4.5,
            size = 1,
            linetype = "longdash",
            aes(x = Po_Pre_Step,y = highfat,
                text = paste("Slope", IIB_4.5_lm$coefficients[2]))) +
  geom_line(data = IIBact,
            size = 1,
            linetype = "solid",
            aes(x = Po_Pre_Step,y = act,
                text = paste("Slope", IIB_act_lm$coefficients[2]))
            )
