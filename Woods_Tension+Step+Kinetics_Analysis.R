...
plot_all_rates <- ggarrange(r2_gg, r3_gg, r4_gg, a2_gg,a3_gg,a4_gg,
                            ncol = 3,
                            nrow = 3)
...
plot_fibers_amp <- ggarrange(a2_plot_fibers, 
                             a3_plot_fibers, 
                             a4_plot_fibers,
...
plot_fibers_rates <- ggarrange(r2_plot_fibers, 
                            ...
                            ncol = 1,
                            nrow = 3)
ggexport(list(plot_fibers_sa,plot_fibers_amp, plot_fibers_rates), 
